            ...
            modelBuilder.Entity("CashMachine.Models.DataBase.Owner", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("3686f45d-5e74-4666-ae76-6cf898d36f90"), AccountNumber = "123456789", IsAbleToTransfer = true, LastName = "Kowalski", Name = "Piotr" },
                        new { Id = new Guid("98d50544-b91e-4491-9bf9-a4d601e5f873"), AccountNumber = "234567899", IsAbleToTransfer = true, LastName = "Nowak", Name = "Maciej" },
                        new { Id = new Guid("9710bb72-956f-4aca-ad4e-9fa133e385d4"), AccountNumber = "111111111", IsAbleToTransfer = true, LastName = "Janicki", Name = "Wojciech" },
                        new { Id = new Guid("8f18e657-4611-4ce1-9854-279fa327144c"), AccountNumber = "999999999", IsAbleToTransfer = true, LastName = "Olejniczak", Name = "Adam" }
                    );
                });
